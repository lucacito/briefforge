      ...
      <div className="flex items-start justify-between">
        ...
        <button
          ...
          className={`opacity-0 group-hover:opacity-100 p-1.5 rounded-lg transition-all duration-200 ml-2 flex-shrink-0 ${
            confirmDelete ? 'bg-red-500/20 text-red-400' : 'hover:bg-white/[0.06] text-white/60 hover:text-white/80'
          }`}
        >
...
function TemplateCard({ template, onApply }: { template: Template; onApply: () => void }) {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onApply}
      className="text-left bg-white/[0.03] hover:bg-white/[0.055] border border-white/[0.07] hover:border-violet-500/25 rounded-xl p-4 transition-all duration-200"
    >
      <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500/20 to-indigo-600/20 flex items-center justify-center mb-3 border border-violet-500/20">
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-br from-violet-600 to-indigo-600 text-white font-medium text-sm shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 transition-shadow"
            >
      ...
      <div className="px-8 py-12 text-center">
        ...
        >
          ...
          <h1 className="text-4xl font-black text-white mb-3 tracking-tight">
            Scope smarter.<br />
            <span className="bg-gradient-to-r from-violet-400 to-indigo-400 bg-clip-text text-transparent">Quote with confidence.</span>
          </h1>
